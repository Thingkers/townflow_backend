# Generated by Django 5.1.9 on 2026-05-19 17:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'created_at'], name='profile_dev_user_id_779086_idx')],
            },
        ),
        migrations.CreateModel(
            name='UserProfile',
            ...
            options={
                'indexes': [models.Index(fields=['user', 'location_label'], name='profile_use_user_id_d81458_idx')],
            },
        ),
    ]
